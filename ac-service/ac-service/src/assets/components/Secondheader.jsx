    ...
    <>
          ...
          <div className="bg-white mt-5 shadow-lg rounded-lg">
            <div className="flex justify-between mx-auto pt-5">
              <div className="lg:flex gap-3 ml-2">
                <img
                  className="rounded-full lg:w-12 w-20"
              ...
              <div>
                <h1 className="text-center lg:leading-[45px] lg:text-[25px] hidden lg:block Chaitanya">
      ...
      <FaRegStar className="text-yellow-400" />
            ...
            <div className="flex lg:flex-row flex-col mt-2">
                ...
                <div className="basis-[65%] mx-auto my-auto lg:mr-20 gap-2 mt-5">
                    ...
                    <div className="grid lg:grid-cols-5 grid-cols-2 gap-3">
                        <img className="" src="https://images.pexels.com/photos/5463576/pexels-photo-5463576.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                        <img className="" src="https://images.pexels.com/photos/18481912/pexels-photo-18481912/free-photo-of-modern-armchairs-and-a-coffee-table-in-a-minimalist-room.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                        <img className="" src="https://images.pexels.com/photos/14465273/pexels-photo-14465273.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                        <img className="" src="https://images.pexels.com/photos/4038907/pexels-photo-4038907.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                        <img className="" src="https://images.pexels.com/photos/6316066/pexels-photo-6316066.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                    </div>
                </div>
            </div>
         ...
         <div className="bg-white mt-5 shadow-lg rounded-lg">
            <div className="grid mx-auto grid-cols-3 pt-5">
                <div className="lg:flex gap-3 ml-2">
                    <img className="rounded-full lg:w-12 w-20" src="https://images.pexels.com/photos/1121796/pexels-photo-1121796.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                    <div>
                        <h1>Vijay Shinde</h1>
      ...
      <FaRegStar className="text-yellow-400" />
            ...
            <div className="bg-white mt-5 shadow-lg rounded-lg">    
                <div className="grid mx-auto grid-cols-3 pt-5 ">
                    <div className="lg:flex gap-3 ml-2">
                        <img className="rounded-full lg:w-12 w-20" src="https://images.pexels.com/photos/91227/pexels-photo-91227.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                        <div>
                            <h1>Krishna Rao</h1>
            ...
            <div className="bg-white mt-5 shadow-lg rounded-lg">
                <div className="grid mx-auto grid-cols-3 pt-5">
                    <div className="lg-flex gap-3 ml-2">
                        <img className="rounded-full lg:w-12 w-20'" src="https://images.pexels.com/photos/769745/pexels-photo-769745.jpeg?auto=compress&cs=tinysrgb&w=600" alt="" />
                        <div>
                            <h1>Sachin Borde</h1>
