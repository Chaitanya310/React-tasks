        ...
        <div className="flex-grow flex flex-col p-4 lg:ml-[267px]">
          <div className="mb-4">
            ...
            <div className="w-full h-[228px] bg-white rounded-b-md shadow-md flex flex-col items-center justify-center">
              ...
              <button className="bg-red-600 text-white w-[144px] h-[45px] rounded-md mt-4">
                Choose Image
              </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 mt-7">
                ...
                defaultValue=""
                  >
                    ...
                    <option value="2">0-5 Years</option>
                    <option value="3">0-10 Years</option>
                    <option value="4">0-20 Years </option>
                    <option value="5">0-50 Years</option>
                  </select>
                </div>
                <div>
